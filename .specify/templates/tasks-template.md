...
- **This project (YaID Wallet)**: `src/app/` (entry adapters), `src/modules/{feature}/app/`
  (presenter · controller · usecase · viewmodel), `src/shared/` (domain · infra · result ·
  clients · environments.ts), `tests/` mirroring `src/` 1:1
...
- [ ] TXXX [P] Additional unit tests in tests/ (mirroring src/ 1:1)
